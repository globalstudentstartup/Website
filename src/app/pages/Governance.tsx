        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-4xl leading-relaxed">
              GSSF operates under an "Extreme Transparency" standard. Financial reports are made available to major donors and regulatory bodies to demonstrate impact at every level.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.1 }}>
              ...
              <ul className="space-y-4 mb-6">
                ...
                <li className="flex items-start">
                  <span className="text-[#242EC0] mr-3 font-bold">•</span>
                  <div>
                    <Link to="/policies/by-laws" className="text-white hover:text-[#242EC0] transition-colors underline">
                      By-Laws
                    </Link>
                  </div>
                </li>
